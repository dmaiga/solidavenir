# Generated by Django 5.2.6 on 2025-10-12 21:08
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('titre', models.CharField(help_text='Titre court du palier (ex: Achat terrain)', max_length=255)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_type', models.CharField(choices=[('admin', 'Administrator'), ('porteur', 'Project Owner'), ('donateur', 'Donor/Philanthropist'), ('investisseur', 'Investor'), ('association', 'Association/NGO')], default='porteur', max_length=15)),
                ('type_financement', models.CharField(blank=True, choices=[('don', 'Pure Donation'), ('pret', 'Loan'), ('equity', 'Equity Investment'), ('mixte', 'Mixed Financing'), ('autre', 'Other Financing Type')], max_length=10, null=True)),
                ...
                ('genre', models.CharField(choices=[('homme', 'Male'), ('femme', 'Female'), ('autre', 'Other'), ('non_specifie', 'Unspecified')], default='non_specifie', max_length=15)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('domaine_principal', models.CharField(choices=[('education', 'Education'), ('sante', 'Health'), ('environnement', 'Environment'), ('droits_humains', 'Human Rights'), ('developpement', 'Community Development'), ('culture', 'Culture'), ('urgence', 'Humanitarian Aid'), ('autre', 'Other')], default='developpement', max_length=50)),
                ...
                ('causes_defendues', models.TextField(blank=True, null=True)),
                ('statut_juridique', models.CharField(choices=[('association', 'Association'), ('ong', 'NGO'), ('fondation', 'Foundation'), ('autre', 'Other Status')], default='association', max_length=50)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('hedera_message_id', models.CharField(blank=True, help_text='ID du message HCS Hedera', max_length=150, null=True)),
